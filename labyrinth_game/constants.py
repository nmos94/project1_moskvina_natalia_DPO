ROOMS = {
    ...
    'secret_garden': {
        'description': (
            'Вы нашли скрытый внутренний садик. '
            'Здесь поют механические птицы и пахнет весной.'
        ),
        'exits': {'west': 'armory'},
    ...
    'dungeon_corridor': {
        'description': (
            'Узкий сырой коридор. Факелы на стенах едва светят. '
            'Слышен скрежет металла.'
        ),
        'exits': {'south': 'trap_room', 'north': 'secret_garden'},
        'items': ['old_bone'],
        'puzzle': (
            'На стене выцарапано: "Зимой и летом одним цветом". Что это?',
            'елка'
        )
    },
}
